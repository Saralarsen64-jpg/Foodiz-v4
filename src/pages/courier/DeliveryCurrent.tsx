...
export default function DeliveryCurrent() {
  ...
  return <CourierShell title="Course active" back="/courier"><div className="weello-card p-10 text-center"><MapPin size={46} className="mx-auto text-weello-gold" /><h2 className="weello-title text-2xl mt-4">Aucune course active</h2><p className="text-weello-gray text-sm mt-2 mb-6">Passez en ligne et choisissez une mission disponible.</p><button onClick={() => navigate("/courier/deliveries/available")} className="weello-btn w-full py-4 flex items-center justify-center gap-2"><Navigation size={18} /> Voir les courses</button></div></CourierShell>;
}
