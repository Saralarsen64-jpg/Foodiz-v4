...
const CHART_DATA: Record<PeriodKey, { label: string; value: number }[]> = {
  day: [
    { label: "10h", value: 42 }, { label: "12h", value: 138 }, { label: "14h", value: 96 },
    { label: "16h", value: 54 }, { label: "18h", value: 128 }, { label: "20h", value: 164 }, { label: "22h", value: 88 },
  ],
  week: [
    { label: "Lun", value: 240 }, { label: "Mar", value: 310 }, { label: "Mer", value: 280 },
    { label: "Jeu", value: 420 }, { label: "Ven", value: 380 }, { label: "Sam", value: 510 }, { label: "Dim", value: 450 },
  ],
  month: [
    { label: "S1", value: 1420 }, { label: "S2", value: 1580 }, { label: "S3", value: 1710 }, { label: "S4", value: 1890 },
  ],
  year: [
    { label: "Jan", value: 4200 }, { label: "Fév", value: 3900 }, { label: "Mar", value: 4700 },
    { label: "Avr", value: 5100 }, { label: "Mai", value: 5600 }, { label: "Juin", value: 5900 },
  ],
};
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="foodiz-card p-5">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="text-[10px] text-foodiz-gray">CA sur la période</p>
            </div>
          </div>
