...
export default function ClientHome() {
  ...
  return (
    <div className="min-h-screen bg-foodiz-black pb-24 animate-fade-in-up relative overflow-x-hidden">
      ...
      {/* BARRE DE NAVIGATION DU BAS (Flottante et élégante) */}
      <div className="fixed bottom-6 left-6 right-6 bg-foodiz-card/90 backdrop-blur-md border border-foodiz-gold/20 rounded-2xl px-6 py-4 flex justify-between items-center z-50 shadow-2xl shadow-black/50 max-w-lg mx-auto">
