  ...
  return (
    <div className="min-h-screen bg-foodiz-black flex flex-col">
      ...
      <main className="flex-1 max-w-md mx-auto w-full px-6 py-8">
        ...
        <div className="my-6 foodiz-card p-4 bg-white/[0.02] border-foodiz-gold/10 text-center">
          <p className="text-[11px] text-foodiz-gray leading-relaxed">
            Authentification sécurisée Foodiz par e-mail. Les connexions Google et Apple seront activées après validation officielle des accès OAuth.
          </p>
        </div>
