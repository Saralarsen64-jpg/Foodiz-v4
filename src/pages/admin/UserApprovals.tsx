...
export default function UserApprovals() {
  ...
  const fetchPendingUsers = async () => {
    const { data, error } = await supabase
      ...
      .neq('role', 'client'); // On ne montre pas les clients (ils sont auto-approuvés)
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#FFF8EA] relative border-x-2 border-foodiz-gold/20 p-6">
      ...
      <p className="text-foodiz-gray mb-8">Ces partenaires et livreurs attendent votre approbation pour accéder à la plateforme.</p>
