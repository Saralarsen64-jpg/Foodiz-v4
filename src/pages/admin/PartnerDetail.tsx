...
export default function AdminPartnerDetail() {
  ...
  return <AdminShell title={restaurant.name} subtitle="Vue 360° partenaire, souscription, activité, règlements et conformité">
    ...
    <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">{[
      ["Commandes livrées", metrics.orders], ["Encaissé clients", euros(metrics.collected)], ["Dû partenaire", euros(metrics.partner)], ["Revenu Foodiz", euros(metrics.foodiz)], ["Panier moyen", euros(metrics.average)],
