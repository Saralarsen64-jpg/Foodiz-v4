...
STRIPE_PLAN_BASIC_MONTHLY=price_basic_monthly_xxx
STRIPE_PLAN_BASIC_YEARLY=price_basic_yearly_xxx
STRIPE_PLAN_PRO_MONTHLY=price_pro_monthly_xxx
STRIPE_PLAN_PRO_YEARLY=price_pro_yearly_xxx
```
